...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <>
      <header className="w-full shrink-0 flex items-center justify-between px-2.5 sm:px-3.5 py-1.5 sm:py-2 select-none bg-black/15 border-b border-white/10 backdrop-blur-sm">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2">
          <button
            ...
            className="p-1.5 sm:p-2 rounded-lg border border-white/30 bg-white/10 hover:bg-white/15 active:scale-95 transition text-white cursor-pointer group"
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-2 sm:px-2.5 py-1 sm:py-1.5 rounded-lg border border-white/30 bg-white/10 hover:bg-white/15 active:bg-white/20 transition text-white font-bold text-xs sm:text-sm tracking-wider cursor-pointer"
          >
            <Pause className="w-3 h-3 sm:w-3.5 sm:h-3.5 fill-current" />
            <span className="tabular-nums font-mono text-xs sm:text-sm font-semibold">
        ...
        <button
          ...
          className="flex items-center gap-1 px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-full bg-emerald-500/20 border border-emerald-400/40 hover:bg-emerald-500/30 transition text-emerald-300 text-xs font-black cursor-pointer shadow-sm"
        ...
        <div className="flex items-center gap-1.5 sm:gap-2">
          <button
            ...
            className="px-2 sm:px-2.5 py-1 sm:py-1.5 rounded-lg border border-white/35 bg-white/10 hover:bg-white/15 active:bg-white/20 transition text-white font-bold text-[10px] sm:text-[11px] tracking-wider uppercase cursor-pointer"
          >
            {difficulty}
          </button>
          ...
          <button
            ...
            onClick={onUseHint}
            aria-label="Use hint"
            className="relative p-1.5 sm:p-2 rounded-lg border border-white/35 bg-white/10 hover:bg-white/15 active:bg-white/20 transition text-white cursor-pointer group"
          >
            <Lightbulb className="w-4 h-4 text-white/90 group-hover:text-yellow-300 transition-colors" />
            {hintCount > 0 && (
              <span className="absolute -top-1 -right-1 bg-amber-400 text-amber-950 text-[9px] sm:text-[10px] font-black rounded-full w-3.5 h-3.5 sm:w-4 sm:h-4 flex items-center justify-center shadow">
                {hintCount}
              </span>
            )}
          </button>
